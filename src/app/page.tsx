...
export default function LoginPage() {
  ...
  return (
    // Usamos las variables del CSS para el fondo principal
    <div className="min-h-screen flex flex-col items-center justify-center p-4 transition-colors duration-300">
      ...
      <button 
        ...
        className="fixed top-4 right-4 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-[var(--bg-card)] shadow-sm active:scale-90 transition-all z-50"
      >
      ...
      <div className="w-full max-w-[340px] sm:max-w-[360px]">
        ...
        {/* Tarjeta de Login (Usa variable --bg-card) */}
        <div 
          style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}
          className="p-6 rounded-[1.5rem] shadow-xl border transition-colors duration-300"
        >
          <div className="mb-5">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 text-sm rounded-xl border border-slate-200 dark:border-slate-800 bg-transparent outline-none transition-all focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-10 py-2 text-sm rounded-xl border border-slate-200 dark:border-slate-800 bg-transparent outline-none transition-all focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                  placeholder="••••••••"
                />
                <button 
                  type="button"
